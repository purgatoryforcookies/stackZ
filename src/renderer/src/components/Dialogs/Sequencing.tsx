    ...
    return (
        <Dialog>
            ...
            <DialogContent data-theme={theme.theme}>
                <DialogHeader>
                    <DialogTitle className="flex items-center pb-3">Yes sequencing</DialogTitle>
                    <DialogDescription>
                        ...
                        <div className="my-3 text-white">
                            <p className="">
                                After setup, these steps are then given to the terminal on next
                                runs.
                            </p>
                            <p className="">
