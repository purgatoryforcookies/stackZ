    ...
    return (
        <div className="flex text-secondary-foreground gap-4 items-center px-2">
            <div className="flex flex-col  items-center">
                ...
                <p className="text-secondary-foreground/50 text-xs self-start pr-20">{port[0].process}</p>
                <p className="text-secondary-foreground/50 text-xs self-start pr-20">PID {port[0].pid}</p>
            </div>
