...
import { Cmd, CustomServer } from '../../types.js'
...
describe('Terminal', () => {
    ...
    const testCommand: Cmd = { id: 'commandId', title: 'Test', command: { cmd: 'echo hello' } }

    const testServer = new Server<CustomServer>({ cors: { origin: '*' } }).listen(3124)
